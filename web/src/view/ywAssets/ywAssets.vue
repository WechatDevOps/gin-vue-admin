<template>
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="实例IP">
          <el-input v-model="searchInfo.linkIp" placeholder="搜索条件" />
        </el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="实例IP" prop="linkIp" width="120" />
        <el-table-column align="left" label="运维端口" prop="port" width="120" />
        <el-table-column align="left" label="账号" prop="user" width="120" />
        <el-table-column align="left" label="密码" prop="password" width="120" />
        <el-table-column align="left" label="过期时间" prop="expiredTime" width="120" />
