<template>
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="登陆次数">
          <el-input v-model="searchInfo.lastTimes" placeholder="搜索条件" />
        </el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="上次登录时间" prop="lastLoginTime" width="120" />
        <el-table-column align="left" label="登陆次数" prop="lastTimes" width="120" />
