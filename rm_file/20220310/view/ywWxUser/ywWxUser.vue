<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="uid" prop="ywid" width="120" />
        <el-table-column align="left" label="头像" width="100">
          <template #default="scope">
            <CustomPic pic-type="avatar" :pic-src="scope.row.wxPhoto" />
          </template>
        </el-table-column>
        <el-table-column align="left" label="昵称" prop="wxName" width="120" />
        ...
        <el-table-column align="left" label="上次登陆时间" prop="lastLoginTime" width="180">
          <template #default="scope">
            <div>{{ formatDate(scope.row.lastLoginTime) }}</div>
          </template>
        </el-table-column>
        <el-table-column align="left" label="上次登陆IP" prop="lastLoginIp" width="150" />
        <el-table-column align="left" label="上次登陆ins" prop="lastLoginInsid" width="120" />
        <el-table-column align="left" label="是否已注册" prop="isRegistered" width="120" >
            <template #default="scope">
            {{ filterDict(scope.row.isRegistered,registerStatus) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="添加时间" prop="insertTime" width="180">
          <template #default="scope">
            <div>{{ formatDate(scope.row.insertTime) }}</div>
          </template>
        </el-table-column>
        ...
        <!-- <el-table-column align="left" label="过期时间" prop="expireTime" width="180" >
          <template v-if="isPermanent===true" #default="scope">
            <div>不过期</div>
          </template>
...
const setOptions = async () =>{
  registerStatus.value = await getDictFunc('isTrue')
}
