<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="id" prop="sessionId" width="120" />
        <el-table-column align="left" label="id" prop="ywid" width="120" />
        <el-table-column align="left" label="loginType字段" prop="loginType" width="120" />
        <el-table-column align="left" label="ip" prop="srcIp" width="120" />
        <el-table-column align="left" label="srcPort字段" prop="srcPort" width="120" />
        <el-table-column align="left" label="ip" prop="ywIp" width="120" />
        ...
        <el-table-column align="left" label="url" prop="replayUrl" width="120" />
