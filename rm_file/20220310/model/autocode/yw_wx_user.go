...
type YwWxUser struct {
      global.GVA_MODEL
      ExpireTime  *int `json:"expireTime" form:"expireTime" gorm:"column:expire_time;comment:,-1;size:19;"`
      InsertTime  *time.Time `json:"insertTime" form:"insertTime" gorm:"column:insert_time;comment:;"`
      IsRegistered  *int `json:"isRegistered" form:"isRegistered" gorm:"column:is_registered;comment:,0,1;size:10;"`
      ...
      Openid  string `json:"openid" form:"openid" gorm:"column:openid;comment:id;size:255;"`
