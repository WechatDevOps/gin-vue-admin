...
var testService = service.ServiceGroupApp.AutoCodeServiceGroup.TestService
...
// @accept application/json
// @Produce application/json
// @Param data query autocodeReq.TestSearch true "分页获取Test列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /test/getTestList [get]
func (testApi *TestApi) GetTestList(c *gin.Context) {
	var pageInfo autocodeReq.TestSearch
	_ = c.ShouldBindQuery(&pageInfo)
	if err, list, total := testService.GetTestInfoList(pageInfo); err != nil {
